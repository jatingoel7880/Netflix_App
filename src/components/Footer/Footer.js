import React from 'react';
  ...
  const Footer = () => {
    return (
      ...
      <footer className="footer bg-[#141414] p-12 mt-28">
      {/* <footer className="bottom-0 left-0 w-full bg-[#141414] py-12 px-48"> */}
        <div className="footer-container mx-auto grid max-w-4xl gap-4 ">
          {/* Social links */}
          <div className="flex gap-4">
            <a href="https://www.facebook.com/NetflixIN/" target="_blank" rel="noopener noreferrer" className="text-white">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="svg-icon svg-icon-facebook-logo ltr-4z3qvp e1svuwfo1" aria-hidden="true">
      ...
      >
        <svg
          ...
          className="svg-icon svg-icon-instagram-logo ltr-4z3qvp e1svuwfo1 font-bold"
          data-name="Instagram"
          aria-labelledby=":R8pkm:"
          aria-hidden="true"
        >
          <path
            fillrule="evenodd"
      ...
      >
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="svg-icon svg-icon-twitter-logo ltr-4z3qvp e1svuwfo1 font-bold"
          data-name="Twitter"
          aria-labelledby=":Rcpkm:"
          aria-hidden="true"
        >
          <path
             fillrule="evenodd"
      ...
      >
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="svg-icon svg-icon-youtube-logo ltr-4z3qvp e1svuwfo1 font-bold"
          data-name="Youtube"
          aria-labelledby=":Rgpkm:"
          aria-hidden="true"
        >
          <path
            fillrule="evenodd"
          ...
          {/* Links */}
          <div className="links grid grid-cols-2 sm:grid-cols-4 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <ul >
          <li>
            <a className="text-[0.8rem] text-gray-400 text-underline" href="">
              Audio Description
            </a>
          </li>
          <li>
  ...
  <button className="border text-sm text-gray-400 border-gray-600 px-1 py-1">Service Code</button>
